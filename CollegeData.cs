...
namespace Scout
{
    ...
    public class CollegeData
    {
        ...
        public string findBranches(string college)
        {
            ...
            workBook = app.Workbooks.Open(@"C:\Users\Sravya Datla\Documents\eamcetdataset.xlsx", 0, true, 5, "", "", true, Microsoft.Office.Interop.Excel.XlPlatform.xlWindows, "\t", false, false, 0, true, 1, 0);
